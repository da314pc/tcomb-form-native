...
var { View, Text, Platform } = require('react-native');
var { Picker: PickerAndroid, PickerIOS } = require('@react-native-community/picker');
var Picker = Platform.OS === 'ios' ? PickerIOS : PickerAndroid;
